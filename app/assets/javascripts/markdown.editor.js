...
(function () {
    ...
    function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
        ...
        function makeSpritedButtonRow() {
            ...
            buttonRow.id = "wmd-button-toolbar" + postfix;
            buttonRow.className = 'btn-toolbar';
            buttonRow = buttonBar.appendChild(buttonRow);
            var xPosition = 0;
            var makeButton = function (insert_to, icon, id, title, XShift, textOp) {
                ...
                if(id === "wmd-link-button") {
                    var textSpan = document.createElement("span");
                    textSpan.innerHTML = " Insert Link";
                    button.appendChild(textSpan);
                }
                insert_to.appendChild(button);
                return button;
            };
            ...
            sectionOne.className = "btn-group";
            buttonRow.appendChild(sectionOne);

            buttons.bold = makeButton(sectionOne, "icon-bold", "wmd-bold-button", "Strong <strong> Ctrl+B", "0px", bindCommand("doBold"));
            buttons.italic = makeButton(sectionOne, "icon-italic", "wmd-italic-button", "Emphasis <em> Ctrl+I", "-20px", bindCommand("doItalic"));
            
            sectionTwo = document.createElement("div");
            sectionTwo.className = "btn-group";
            sectionTwo.style.marginLeft = "8px";
            buttonRow.appendChild(sectionTwo);

            buttons.link = makeButton(sectionTwo, "icon-share-alt", "wmd-link-button", "Hyperlink <a> Ctrl+L", "-40px", bindCommand(function (chunk, postProcessing) {
